...
# print(f"Simple Tasks: Took {(end_time-start_time).seconds}") # Simple Tasks: Took 45
...
@app_2.post(
    "/task",
    status_code=202 # 비동기 작업이 등록됐을 때, HTTP Respose 202 (Accepted)를 보통 리턴한다. (https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/202)
)
...
# end_time = datetime.now()
# print(f"Simple Tasks: Took {(end_time-start_time).seconds}") # Simple Tasks: Took 9
