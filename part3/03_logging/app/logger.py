...
log_format = ", ".join(
    [f"%({key})s" for key in sorted(["filename", "levelname", "name", "message", "created"])]
)
...
if __name__ == "__main__":
    ...
    logger = get_ml_logger(
        ...
        credential_json_path="/Users/shkim/gcp/shkim4738/product-serving/accounts/product-serving-4b8f608a40c6.json", # FIXME
        table_ref="product-serving.online_serving_logs.mask_classification" # FIXME: 빅쿼리 테이블 주소 (e.g., product-serving.online_serving_logs.mask_classification)
    )
